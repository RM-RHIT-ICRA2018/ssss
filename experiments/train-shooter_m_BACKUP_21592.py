...
<<<<<<< HEAD
def CNN_model(input, num_outputs=12, scope="CNN", batch_size=10, reuse=tf.AUTO_REUSE):
=======
def CNN_model(input, num_outputs=12, scope="CNN", reuse=tf.AUTO_REUSE):
>>>>>>> 04db1dedbd4be16f9a65e2e8658effdb3d39b6f2
    # This model takes as input an observation and returns values of all actions
    with tf.variable_scope(scope, reuse=reuse):
